...
int main(int argc, char** argv)
{
    ...
    std::list<const sdds::Vehicle*> vehicles;
    {
        ...
        auto fastVehicles = [=] (const sdds::Vehicle* rhs){
            return rhs->topSpeed() > 300 ? true : false;
        };
    ...
    std::cout << std::endl;
    {
        ...
        auto brokenVehicles = [=] (const sdds::Vehicle* rhs){
            return rhs->condition() == "broken"  ? true : false;
        };
